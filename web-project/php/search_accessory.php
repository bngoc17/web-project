...
@$price_accessory = $_GET["price_accessory"];
@$search = $_GET["search"];
...
<body>
    ...
    <form action="search_accessory.php" method="get">
        <?php
        if (isset($_GET["accessory"]) || isset($search))
        ...
        if (isset($_GET["price_accessory"]) || isset($price_search))
    ...
    <?php if (!empty($price_search)) echo "<p class='login'>Phụ kiện có giá dưới: $price_search</p>" ?> <br> <br>
    <span class="header1">
